...
```
	Текст с отступом, сделанным с помощью табуляции, будет выглядеть как блок кода в
...
Пример простой сноски[[1]](https://publish.obsidian.md/#fn-1-7731f62984c18968) и пример сноски подлиннее[[2]](https://publish.obsidian.md/#fn-2-7731f62984c18968).

```md
Сноски также можно оставлять прямо в тексте.^[обратите внимание, что карет `^` при этом выносится за скобки.]
```

Сноски также можно оставлять прямо в тексте.[[3]](https://publish.obsidian.md/#fn-3-7731f62984c18968)
...
1. со смыслом![↩︎](https://publish.obsidian.md/#fnref-1-7731f62984c18968)
...
2. с несколькими абзацами и кодом.
    ...
    Абзацев может быть сколько угодно.[↩︎](https://publish.obsidian.md/#fnref-2-7731f62984c18968)
    
3. обратите внимание, что карет `^` при этом выносится за скобки. [↩︎](https://publish.obsidian.md/#fnref-3-7731f62984c18968)


<span style="color:red;">Html-разметка, красный текст</span>
...
[Импорт Markdown-файлов](https://publish.obsidian.md/help-ru/%D0%9F%D0%BB%D0%B0%D0%B3%D0%B8%D0%BD%D1%8B/%D0%98%D0%BC%D0%BF%D0%BE%D1%80%D1%82+Markdown-%D1%84%D0%B0%D0%B9%D0%BB%D0%BE%D0%B2)
